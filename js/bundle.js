...
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/tab */ "./js/modules/tab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tab__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
...
function slider(_ref) {
  ...
  var slides = document.querySelectorAll(slide),
      ...
      width = window.getComputedStyle(slidesWrapper).width; // showSlides(slideIndex);
  // if (slides.length < 10) {
...
function tab(tabsSelector, tabsContentSelectom, tabsParentSelector, activeClass) {
  var tabs = document.querySelectorAll(tabsSelector),
      tabsContent = document.querySelectorAll(tabsContentSelectom),
